...
namespace ResourceServer.Controllers
{
  ...
  public class ConfiguracionController : ApiController
  {
    ...
    #region Relacion-GranoSIL-GranoSTOP 
    ...
    #region Relacion-PuertoSIL-PuertoSTOP

    [HttpPost]
    [Route("api/RelacionPuertoSILPuertoSTOP/GetRelaciones")]
    public HttpResponseMessage GetRelacionPuertoSILPuertoSTOP(RelacionPuertoSILPuertoSTOPDTO relacion)
    {
      if (ModelState.IsValid)
      {
        ServicioRelacionPuertoSILPuertoSTOP servicio = new ServicioRelacionPuertoSILPuertoSTOP();
        return Request.CreateResponse(HttpStatusCode.OK, servicio.GetRelaciones(relacion));
    ...
    [HttpPost]
    [Route("api/RelacionPuertoSILPuertoSTOP/AddRelacion")]
    public HttpResponseMessage AddRelacion(RelacionPuertoSILPuertoSTOPDTO relacion)
    {
      if (ModelState.IsValid)
      {
        ServicioRelacionPuertoSILPuertoSTOP servicio = new ServicioRelacionPuertoSILPuertoSTOP();
    ...
    [HttpPost]
    [Route("api/RelacionPuertoSILPuertoSTOP/DeleteRelacion")]
    public HttpResponseMessage DeleteRelacion(RelacionPuertoSILPuertoSTOPDTO relacion)
    {
      if (ModelState.IsValid)
      {
        ServicioRelacionPuertoSILPuertoSTOP servicio = new ServicioRelacionPuertoSILPuertoSTOP();
    ...
    [HttpPost]
    [Route("api/RelacionPuertoSILPuertoSTOP/UpdateRelacion")]
    public HttpResponseMessage UpdateRelacion(RelacionPuertoSILPuertoSTOPDTO relacion)
    {
      if (ModelState.IsValid)
      {
        ServicioRelacionPuertoSILPuertoSTOP servicio = new ServicioRelacionPuertoSILPuertoSTOP();
