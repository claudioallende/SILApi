...
{
    public class CuposAgrupadosDetalleCyo : ICuposAgrupadosDetalle
    {
        ...
        {
            CuposAgrupadosDetalleCyo recievedObject = (CuposAgrupadosDetalleCyo)obj;
        ...
        public virtual bool TieneCuposAsignados()
        {
            for (int Dia = 0; Dia <= 20; Dia++) {
                if (Int32.Parse(this.GetType().GetProperty("D" + Dia + "Cr").GetValue(this).ToString()) != 0) return true;
            }
            return false;
        }
    }
