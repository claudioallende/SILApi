...
{
    public class CuposAgrupadosCyo : ICuposAgrupados
    {
        ...
        public virtual long CorredorC { get; set; }
        [Display(Name = "Cuenta CorredorV")]
        public virtual long CorredorV { get; set; }
        ...
        {
            CuposAgrupadosCyo recievedObject = (CuposAgrupadosCyo)obj;
