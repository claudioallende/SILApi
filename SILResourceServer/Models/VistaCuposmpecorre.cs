...
{
    public class VistaCuposmpecorre
    {
        ...
        public virtual long Pendaplicar { get; set; }
        public virtual long Transito { get; set; }
        public virtual int Cupotorgado { get; set; }

        public override bool Equals(object obj)
        {
            VistaCuposmpecorre recievedObject = (VistaCuposmpecorre)obj;

            if (ReferenceEquals(recievedObject, null)) return false;
            if (ReferenceEquals(recievedObject, this)) return true;

            if ((this.Producto == recievedObject.Producto)
                && (this.Compcta == recievedObject.Compcta)
                && (this.Centro == recievedObject.Centro)
