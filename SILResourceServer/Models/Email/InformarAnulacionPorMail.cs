...
namespace ResourceServer.Models.Email
{
    public class InformarAnulacionPorMail : ServicioInformarCupos
    {
        ...
        protected override void InformarYGuardarCupos(IList<Cupos> CuposInformar, ServiceEmail ServicioEmail, string CorreosElectronicosDestinatarios, ISession Session)
        {
            ...
            EnviarEmail(ServicioEmail, CorreosElectronicosDestinatarios);
        }

        public void EnviarEmail(ServiceEmail ServicioEmail, string CorreosElectronicosDestinatarios)
        {
